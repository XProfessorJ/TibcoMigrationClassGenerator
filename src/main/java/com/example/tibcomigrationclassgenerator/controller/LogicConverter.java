...
import com.example.tibcomigrationclassgenerator.service.Impl.SimpleHeaderConversionStrategy;
...
public class LogicConverter {
    ...
    public LogicConverter() {
        ...
        strategyMap.put("SimpleHeader", new SimpleHeaderConversionStrategy());
        // 可以继续扩展新的转换策略
    }
    ...
    public String convertLogic(String comment) {
        ...
        if(comment.startsWith("$Start/root/")) {
            return strategyMap.get("SimpleHeader").convert(comment);
        }
